...
static const Game GameList[NB_STV_GAMES]={
  ...
  {"Decathlete (JUET 960424 V1.000)",
    ...
    GAME_BYTE_BLOB, "epr18967.133",    0x0300000, 0x0100000,
  ...
  {"Final Arch (J 950714 V1.001)",
	...
	GAME_BYTE_BLOB, "mpr18257.2",  0x0400000, 0x0400000,
  ...
  {"Pebble Beach - The Great Shot (JUE 950913 V0.990)",
   0,
   {
    ...
    GAME_BYTE_BLOB, "epr18737.13",    0x0200000, 0x0080000,
    GAME_BYTE_BLOB, "epr18737.13",    0x0300000, 0x0080000,
	GAME_WORD_BLOB, "mpr20967.7",    0x0200000, 0x0200000,
	GAME_WORD_BLOB, "mpr20963.2",    0x0400000, 0x0400000,
	GAME_WORD_BLOB, "mpr20964.3",    0x0800000, 0x0400000,
	GAME_WORD_BLOB, "mpr20965.4",    0x0c00000, 0x0400000,
  ...
  {"Puzzle & Action: Sando-R (J 951114 V1.000)",
   0,
   {
    ...
    GAME_BYTE_BLOB, "mpr18635.8",    0x0400000, 0x0400000,
	GAME_WORD_BLOB, "mpr18636.9",   0x2000000, 0x0400000,
    GAME_BYTE_BLOB, "mpr18636.9",    0x0800000, 0x0400000,
	GAME_WORD_BLOB, "mpr18637.10",  0x2400000, 0x0400000,
    GAME_BYTE_BLOB, "mpr18637.10",    0x0c00000, 0x0400000,
	GAME_WORD_BLOB, "mpr18638.11",  0x2800000, 0x0400000,
    GAME_BYTE_BLOB, "mpr18638.11",    0x1000000, 0x0400000,
        GAME_END, "", 0, 0
    },
  },
